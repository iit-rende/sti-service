...
public final class IndexValueSetTest {

	private static Logger log = Logger.getLogger(IndexValueSetTest.class);
	...
	private static final String SOLR_URL = "http://web30.linksmt.it/solr/sti_valueset/update";
	...
	private static final String CODE_SYSTEM = "TestMatteoVS";
	...
	private static void addSingleDocumentTest() {
		...
		try {
			...
			JsonObject jsonObject = NewVersionValueSetWorkflow.getDocumentMock();
